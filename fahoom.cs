...
namespace IMGUITEST
{
    public class Render
    {
        ...
        public void oRender()
        {
            ...
            ImGui.Begin("Fahoom Projectile Motion Simulator", ImGuiWindowFlags.MenuBar | ImGuiWindowFlags.NoCollapse | ImGuiWindowFlags.NoDocking | ImGuiWindowFlags.NoResize | ImGuiWindowFlags.NoMove | ImGuiWindowFlags.NoTitleBar);
            ...
            if (fahoom == true)
            {
                ...
                if (fahoomBool == true)
                {
                    windowxsize = 1000;
                    windowysize = 1000;
                    ImGui.Text("Insert Fahoom Image");
                }
                if (fahoomBool == false)
                {
                    windowxsize = 500;
